    ...
    public String paymentManagement(Model model) {
        try {
            ...
            List<PaymentDTO> payments = allPayments.stream()
                    .sorted((p1, p2) -> {
                        try {
                            // Sắp xếp theo trạng thái: DANG_XU_LY lên trên, sau đó theo ngày tạo giảm dần
                            Payment.TrangThaiPayment status1 = p1.getTrangThai();
                            Payment.TrangThaiPayment status2 = p2.getTrangThai();
                            ...
                            if ((status1 == Payment.TrangThaiPayment.DANG_XU_LY) == (status2 == Payment.TrangThaiPayment.DANG_XU_LY)) {
                                ...
                                // DANG_XU_LY lên trên
                                return status1 == Payment.TrangThaiPayment.DANG_XU_LY ? -1 : 1;
                            }
                        } catch (Exception e) {
